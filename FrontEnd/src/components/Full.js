    ...
    return (
        <div>
            ...
            {infoDisplay === true && <div class="py-6 px-12 place-content-center">
                <h1 class="font-bold text-gray-500 flex justify-center text-lg pb-4">Information</h1>
                <h2 class="font-medium">About Get High</h2>
                <p> Get High was created as a fun project to help assist in the exploration of local places.
                    ...
                    areas to recreate. Ultimately this app is solely for entertainment purposes. Some of these points may be
                    located in areas that are inaccessible or on private property. Be sure to do your own research before 
                    attempting to access any of these points, and always abide by the policies land managers have put in place.</p>    
                <h2 class="font-medium pt-4">How To Use</h2>
               <p>Get High is simple to use. Just put in any zip code in the United States and the algorithm will 
                   return a list of the 10 highest points within a 30-mile radius. The algorithm may not get all the way to the highest 
                   summit, but it will usually get close enough to place a point somewhere along some of the highest features. Data on 
                   the highest points is stored in a database once it is calculated for quicker load times. If you are the first one to put in a particular 
                   zip code it will take longer to return data since it will be calculated in real time. If that is the case, just be 
