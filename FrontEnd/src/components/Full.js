    ...
    return (
        <div class="z-20 absolute top-5 right-7 bg-indigo-100 rounded-lg py-4">
            ...
            <div class="flex justify-center p-3">
                <button class="bg-yellow-200 h-12 w-12 rounded-full shadow-md focus:outline-none hover:shadow-lg transform hover:scale-105 transition duration-200 ease-in-out">
