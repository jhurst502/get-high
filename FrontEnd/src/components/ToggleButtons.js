...
const ToggleButtons = ({onToggle, highlighted}) => {
    ...
    return (
        <div class="flex justify-center p-3">
            <button onClick={decrement} class="bg-gray-300 h-12 w-12 rounded-full shadow-md focus:outline-none hover:shadow-lg transform hover:scale-105 transition duration-200 ease-in-out">
            ...
            <button onClick={increment} class="bg-gray-300 h-12 w-12 rounded-full shadow-md focus:outline-none hover:shadow-lg transform hover:scale-105 transition duration-200 ease-in-out">
